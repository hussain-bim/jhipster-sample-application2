...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.Task.class.getName() + ".titles");
            createCache(cm, io.github.jhipster.application.domain.Task.class.getName() + ".jobs");
            createCache(cm, io.github.jhipster.application.domain.Activity.class.getName());
            ...
            createCache(cm, io.github.jhipster.application.domain.Task.class.getName() + ".activities");
